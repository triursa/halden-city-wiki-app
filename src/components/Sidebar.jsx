    ...
    <>
      ...
      <aside
        className={`
          ...
          bg-[#0d0d14] border-r border-[rgba(255,255,255,0.08)]
      ...
      >
        ...
        <Link
          to="/"
          onClick={onClose}
          className="block px-6 py-5 border-b border-[rgba(255,255,255,0.06)] hover:bg-[rgba(255,255,255,0.04)] transition-colors"
        >
        ...
        <Link
          to="/search"
          onClick={onClose}
          className="flex items-center gap-2 px-6 py-3 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[rgba(255,255,255,0.04)] transition-colors"
        >
          <span>🔍</span>
          <span>Search</span>
        ...
        {/* Bottom info */}
        <div className="absolute bottom-0 left-0 right-0 px-6 py-4 border-t border-[rgba(255,255,255,0.06)] text-xs text-[var(--text-dim)]">
